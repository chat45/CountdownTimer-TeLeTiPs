...
HELP_TEXT = "❓ Команды:\n/set <секунды> <текст>\n/stopc — остановить таймер"
GROUP_TEXT = "💬 Это пример группового описания. Ты можешь изменить текст тут."
TUTORIAL_TEXT = "📺 Учебник пока не добавлен. Можешь сделать свой."
